    ...
    <div class="info__table">
        ...
        <?php foreach ($products as $product) : ?>
            <div class="table__productsByCategory">
                <p><?= $product->id ?></p>
                <a class="noWhite" href="/app/admin/product.php?category=<?= $product->category_id ?>">
                    <p class="link"><?= $product->product_name ?></p>
                </a>
                ...
                <p><?= $product->photo ?></p>
                <p><?= $product->price ?></p>
                <a class="noWhite" href="/app/admin/product.php?executor=<?= $product->executor_id ?>">
                    <p class="link"><?= $product->executor_name ?></p>
                </a>
            </div>
        <?php endforeach ?>
    </div>
